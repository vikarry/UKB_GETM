...
parser.add_argument('--embedding1', type=str, default="vertex_embeddings.npy", help='file contained prettrained rho')
parser.add_argument('--embedding2', type=str, default="vertex_embeddings.npy", help='file contained prettrained rho')
